...
Healthcare domain professional with a **Master of Pharmacy in Pharmacology** and experience in pharmaceutical **Business Development** and **Regulatory Affairs**. Transitioning into **Business Analysis** and **Healthcare Technology** with practical skills in requirements elicitation, stakeholder management, BRD/FRD, user stories, acceptance criteria, BPMN, Agile/Scrum, Jira, UAT, API concepts, SQL/MySQL, and Power BI. Developed healthcare technology portfolio case studies across hospital management, clinical trials, AI-enabled RCM, and healthcare analytics.
